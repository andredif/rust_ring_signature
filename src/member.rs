...
pub struct Member {
    ...
    pub public_set: PublicSet,

    // This is the hash of the first public key
    // in the public set.
    pub hashed_pubkey_basepoint: RistrettoPoint,
...
impl Member {
    ...
    // Creates a member who will be used for verification in a signature
    pub fn new_member_with_responses(
    ...
    pub fn is_current_signer(&self, hashed_pubkey_point: RistrettoPoint) -> bool{
        self.hashed_pubkey_basepoint == hashed_pubkey_point
    }
